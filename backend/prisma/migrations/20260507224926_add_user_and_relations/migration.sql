...
INSERT INTO "new_Entry" ("category_id", "date", "endDate", "id", "name", "reason", "recurrence", "source", "status", "type", "value") SELECT "category_id", "date", "endDate", "id", "name", "reason", "recurrence", "source", "status", "type", "value" FROM "Entry";
DROP TABLE "Entry";
...
INSERT INTO "new_Goal" ("current_amount", "deadline", "id", "initial_amount", "name", "target_amount") SELECT "current_amount", "deadline", "id", "initial_amount", "name", "target_amount" FROM "Goal";
DROP TABLE "Goal";
